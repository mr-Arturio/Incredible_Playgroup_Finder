  ...
  return (
    <div className="fixed inset-0 bg-purple-800 z-50 flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col space-y-6 text-white text-2xl">
        ...
        <Link href="https://www.parentresource.ca/copy-of-our-impact" onClick={toggleMenu}>
          Get Involved
        </Link>
        <Link href="https://www.parentresource.ca/programs" onClick={toggleMenu}>
          Parents
        </Link>
        <Link href="https://www.parentresource.ca/professionals" onClick={toggleMenu}>
          Professionals
        </Link>
        <Link href="https://www.parentresource.ca/blog" onClick={toggleMenu}>
          Blog
        </Link>
        <Link href="https://www.parentresource.ca/volunteering" onClick={toggleMenu}>
          Contact
        </Link>
      </div>
    </div>
